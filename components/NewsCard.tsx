...
export default function NewsCard({ item, index }: NewsCardProps) {
    ...
    return (
        <motion.a
            ...
            className="group block bg-white rounded-3xl shadow-sm hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 hover:scale-[1.02]"
        >
            ...
            <div className="w-full aspect-video relative bg-gray-50 flex items-center justify-center border-b border-gray-100 overflow-hidden">
                {imgSrc ? (
                    <Image
                        ...
                        unoptimized // Allow external images without next.config.js whitelisting dance during this iteration
                    />
                ) : (
